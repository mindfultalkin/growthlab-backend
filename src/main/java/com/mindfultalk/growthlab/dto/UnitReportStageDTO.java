...
public class UnitReportStageDTO {
    ...
    private List<SubconceptReportStageDTO> subconcepts;
	...
	public List<SubconceptReportStageDTO> getSubconcepts() {
		return subconcepts;
	}
	public void setSubconcepts(List<SubconceptReportStageDTO> subconcepts) {
